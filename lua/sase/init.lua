...
--- })
--- ```
--- @param opts? { complete?: { keymap?: boolean|string, completion_backend?: "auto"|"lsp"|"legacy" }, lsp?: { enabled?: boolean, cmd?: string|string[], native_completion?: "auto"|boolean, allow_all_markdown?: boolean }, alt_highlight?: { enabled?: boolean, allow_all_markdown?: boolean, filetypes?: string[] }, alt_editing?: { enabled?: boolean, allow_all_markdown?: boolean, filetypes?: string[] } }
