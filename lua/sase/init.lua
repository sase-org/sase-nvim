...
--- })
--- ```
--- @param opts? { complete?: { keymap?: boolean|string, completion_backend?: "auto"|"lsp"|"picker" }, lsp?: { enabled?: boolean, cmd?: string|string[], native_completion?: "auto"|boolean, allow_all_markdown?: boolean }, glossary_highlight?: { enabled?: boolean }, xprompt_highlight?: { enabled?: boolean }, project_tag_highlight?: { enabled?: boolean }, alt_highlight?: { enabled?: boolean, allow_all_markdown?: boolean, filetypes?: string[] }, alt_editing?: { enabled?: boolean, allow_all_markdown?: boolean, filetypes?: string[] }, xprompt_spacer?: { enabled?: boolean, allow_all_markdown?: boolean, filetypes?: string[] } }
function M.setup(opts)
	opts = opts or {}
	require("sase.lsp").setup(opts.lsp or {})
	require("sase.glossary_highlight").setup(opts.glossary_highlight or {})
	require("sase.xprompt_semantic_highlight").setup(opts.xprompt_highlight or {})
