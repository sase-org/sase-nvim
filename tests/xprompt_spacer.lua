...
same(spacer.plan_colon("#optional ", 10, always(true)), { start = 9, stop = 10 }, "plan targets optional-only spacer")
same(spacer.plan_colon("#!opt ", 6, always(true)), { start = 5, stop = 6 }, "plan handles #! standalone reference")
same(
...
xprompt._set_cache({
	...
	},
	{
		...
		type = "workflow",
		inputs = { { name = "x", type = "word", required = false } },
		preview = "",
	},
})
